...
\
`newdata`` ``<-`` `[`tibble`](https://tibble.tidyverse.org/reference/tibble.html)`(`\
`  par ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``0``, ``1``, ``2``, ``0``, ``1``, ``2``, ``1``)``,`\
`  spore ``=`` `[`c`](https://rdrr.io/r/base/c.html)`(``0``, ``1``, ``2``, ``1``, ``0``, ``1``, ``1``)`\
`)`` ``|>`\
`  `[`mutate`](https://dplyr.tidyverse.org/reference/mutate.html)`(`\
`    par ``=`` `[`as.factor`](https://rdrr.io/r/base/factor.html)`(``par``)``,`\
`    spore ``=`` `[`as.factor`](https://rdrr.io/r/base/factor.html)`(``spore``)`\
