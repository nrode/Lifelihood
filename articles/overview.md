...
This document provides an overview of the internal workings of the
**Lifelihood** R package. It is intended for developers and contributors
who wish to understand or extend the package’s functionality.
...
The **Lifelihood** package is organized into the following primary
components:
...
- `tests/`: Unit and integration tests for validating package
  functionality.
