...
- Do not make changes other than the one asked. If you find issues in code, mention them as the end of your task and summarize what is wrong and could we possibly fix it.
