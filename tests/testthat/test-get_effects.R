test_that("Parsing the effect estimation values.", {
  lines <- c(
    ...
    "eff_survival_param2_type1:geno1 -0.68288974 0.00000000",
    "eff_survival_param2_type2:geno1 -0.36220195 0.00000000",
    ...
    "int_maturity_param2 -2.94007876 0.00000000",
    "eff_maturity_param2_geno1 -0.74856079 0.00000000",
    ...
    "survival_param2 0.05000000 1000.00000000",
    ...
    "maturity_param2 0.00250000 10.00000000",
  ...
  expected <- data.frame(
    name = c(
      ...
      "int_survival_param2",
      "eff_survival_param2_geno1",
      "eff_survival_param2_type1",
      "eff_survival_param2_type2",
      "eff_survival_param2_type1:geno1",
      "eff_survival_param2_type2:geno1",
