...
var
  FactArray: array[0..NFACT] of
  Float = (1.0, 1.0, 2.0, 6.0, 24.0, 120.0, 720.0, 5040.0, 40320.0,
    ...
    263130836933693530167218012160000000.0, 8683317618811886495518194401280000000.0);
...
const
  STIR: TabCoef = (
    7.147391378143610789273E-4, -2.363848809501759061727E-5,
    -5.950237554056330156018E-4,
    6.989332260623193171870E-5,
    7.840334842744753003862E-4, -2.294719747873185405699E-4,
...
const
  S: TabCoef = (-1.193945051381510095614E-3,
    7.220599478036909672331E-3, -9.622023360406271645744E-3,
    -4.219773360705915470089E-2,
    1.665386113720805206758E-1, -4.200263503403344054473E-2,
  ...
  SN: TabCoef = (
    ...
    9.621911155035976733706E-3, -4.219773343731191721664E-2,
    -1.665386113944413519335E-1, -4.200263503402112910504E-2,
    6.558780715202536547116E-1,
    5.772156649015328608727E-1, -1.000000000000000000000E0,
    0);
var
  P: Float;
begin
...
const
  P: TabCoef = (
    4.885026142432270781165E-3, -1.880801938119376907179E-3,
    8.412723297322498080632E-4, -5.952345851765688514613E-4,
    7.936507795855070755671E-4, -2.777777777750349603440E-3,
...
const
  ...
  Q: TabCoef = (-1.397148517476170440917E-5,
    2.346584059160635244282E-4, -1.237799246653152231188E-3,
    -7.955933682494738320586E-4,
    2.773706565840072979165E-2, -4.633887671244534213831E-2,
...
const
  P: TabCoef = (-2.163690827643812857640E3, -8.723871522843511459790E4,
  ...
  Q: TabCoef = (-5.139481484435370143617E2, -3.403570840534304670537E4,
...
var
  Ans, C, Yc, Ax, Y, Z, R, T, Pk, Pkm1, Pkm2, Qk, Qkm1, Qkm2: Float;
begin
  MathError := FN_OK;
...
var
  Xk, Pk, Pkm1, Pkm2, Qk, Qkm1, Qkm2, K1, K2, K3, K4, K5, K6, K7,
  K8, R, T, Ans, Thresh: Float;
  N: integer;
label
  CDone;
begin
...
const
  P0: TabCoef = (
    8.779679420055069160496E-3, -7.649544967784380691785E-1,
    2.971493676711545292135E0, -4.144980036933753828858E0,
    2.765359913000830285937E0, -9.570456817794268907847E-1,
    1.659219375097958322098E-1, -1.140013969885358273307E-2,
    0, 0);

  Q0: TabCoef = (-5.303846964603721860329E0,
    9.908875375256718220854E0, -9.031318655459381388888E0,
    4.496118508523213950686E0, -1.250016921424819972516E0,
    1.823840725000038842075E-1, -1.088633151006419263153E-2,
    0, 0, 0);
  ...
  P3: TabCoef = (
    ...
    2.114822217898707063183E-1, -6.500909615246067985872E-3,
    -7.279315200737344309241E-4, -1.275404675610280787619E-5,
    -6.433966387613344714022E-8, -7.772828380948163386917E-11,
    0, 0);

  Q3: TabCoef = (
    2.278210997153449199574E0,
    2.345321838870438196534E-1, -6.916708899719964982855E-3,
    -7.908542088737858288849E-4, -1.387652389480217178984E-5,
    -7.001476867559193780666E-8, -8.458494263787680376729E-11,
    0, 0, 0);
var
...
begin
  ...
  if Nu < 1 then
    ...
    FStudent := 1.0 - IBeta(0.5 * Nu, 0.5, Nu / (Nu + Sqr(X)));
end;
...
begin
  ...
  if (A <= 0.0) or (B <= 0.0) or (X < 0.0) or (X > 1.0) then
    ...
    if A < 1.0 then DBeta := DefaultVal(FN_SING, MAXNUM)
    else
      DBeta := 0.0
  else if X = 1.0 then
    if B < 1.0 then DBeta := DefaultVal(FN_SING, MAXNUM)
    else
      DBeta := 0.0
  else
  begin
    L := LnGamma(A + B) - LnGamma(A) - LnGamma(B) + (A - 1.0) *
      Ln(X) + (B - 1.0) * Ln(1.0 - X);
    DBeta := Expo(L);
  end;
end;
