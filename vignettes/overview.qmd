---
title: "Overview of Lifelihood (for developers)"
date: today
output: 
  html_document:
    toc: yes
...
- `src/`: Houses the Pascal source code and executables. Only the one in `src/lazarus/` should be used.
...
The `src/` directory includes both the source (`.pas`) and compiled files:
