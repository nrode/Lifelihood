...
- [How to use the lifelihood package](fitting-your-first-model-in-lifelihood.html)
...
You can get the **default** parameter boundaries with the `default_bounds_df()` function and by passing the `lifelihoodData` object:
