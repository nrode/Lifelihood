---
title: "1 - What is the required data format"
...
- `extra1` Column name of the first column to add in the input data file
- `extra2` Column name of the second column to add in the input data file
- `extra3` Column name of the third column to add in the input data file
...
Once our dataframe has the right format, we now have to [create a configuration file](2-setting-up-the-configuration-file.html).