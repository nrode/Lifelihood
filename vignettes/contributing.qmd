...
_Note: Setting `compile = FALSE` ensures that code in the `/` directory is not compiled. This option is typically used when working with packages that include C++ code. Learn more [here](https://forum.posit.co/t/devtools-load-all-works-on-mac-but-not-on-windows-for-a-given-package/190503)_
