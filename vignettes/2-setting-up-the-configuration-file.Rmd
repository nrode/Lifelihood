...
_Note 2: interaction effect, noted with `*` can also be written with the `:` symbol._
...
- `increase_in_tof_proportional_to_number_of_offspring`: Increase in trade-off proportional to the number of offspring
- `lin_decrease_hazard`: Linear decrease in hazard rate with time since maturity
- `quad_senescence_of_interval_between_reproduction_events`: Quadratic senescence of interval between reproduction events
