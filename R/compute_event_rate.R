...
#' over the interval).
#'Note that for reproduction event, the first reproduction event of each individual cannot be computed if maturity was not observed (i.e. mat_clutch is true)
#'
#' @import dplyr
#'
#' @export
